...
export let BattleMovedex = {
    ...
    breakingswipe: {
        ...
        category: 'Physical',
        desc:
            "100% chance to lower the foe's Attack by 1 stage. Hits all adjacent foes.",
    ...
    dive: {
        ...
        onTryMove(attacker, defender, move) {
            ...
            if (
                ...
                attacker.template.species === 'Cramorant' &&
    ...
    gmaxcuddle: {
        ...
        category: 'Physical',
        desc:
            "Infatuates opponents. Base Power scales with the base move's Base Power.",
    ...
    gmaxfinale: {
        ...
        category: 'Physical',
        desc:
            "Heals user and allies for 1/6 of their post-Gigantamax max HP. Base Power scales with the base move's Base Power.",
    ...
    gmaxfoamburst: {
        ...
        category: 'Physical',
        desc:
            "Lowers the Speed of opponents by 2 stages. Base Power scales with the base move's Base Power.",
    ...
    gmaxgoldrush: {
        ...
        category: 'Physical',
        desc:
            "Confuses opponents. Base Power scales with the base move's Base Power.",
    ...
    gmaxgravitas: {
        ...
        category: 'Physical',
        desc:
            "Summons Gravity. Base Power scales with the base move's Base Power.",
    ...
    gmaxmalodor: {
        ...
        category: 'Physical',
        desc:
            "Poisons opponents. Base Power scales with the base move's Base Power.",
    ...
    gmaxmeltdown: {
        ...
        category: 'Physical',
        desc:
            "Applies Torment to opponents. Base Power scales with the base move's Base Power.",
    ...
    gmaxreplenish: {
        ...
        category: 'Physical',
        desc:
            "Has a 50% chance of restoring all Berries on the user's side. Base Power scales with the base move's Base Power.",
    ...
    gmaxresonance: {
        ...
        category: 'Physical',
        desc:
            "Summons Aurora Veil. Base Power scales with the base move's Base Power.",
    ...
    gmaxsnooze: {
        ...
        category: 'Physical',
        desc:
            "Has a 50% chance of applying Yawn to the target. Base Power scales with the base move's Base Power.",
    ...
    gmaxsteelsurge: {
        ...
        category: 'Physical',
        desc:
            "Sets a Steel-type entry hazard. Base Power scales with the base move's Base Power.",
    ...
    gmaxstonesurge: {
        ...
        category: 'Physical',
        desc:
            "Sets Stealth Rock. Base Power scales with the base move's Base Power.",
    ...
    gmaxstunshock: {
        ...
        category: 'Physical',
        desc:
            "Opponents are each randomly paralyzed or poisoned. Base Power scales with the base move's Base Power.",
    ...
    gmaxsweetness: {
        ...
        category: 'Physical',
        desc:
            "Cures status on user's team. Base Power scales with the base move's Base Power.",
    ...
    gmaxtartness: {
        ...
        category: 'Physical',
        desc:
            "Lowers opponents' evasion by 1 stage. Base Power scales with the base move's Base Power.",
    ...
    gmaxterror: {
        ...
        category: 'Physical',
        desc:
            "Traps opponents. Base Power scales with the base move's Base Power.",
    ...
    gmaxvoltcrash: {
        ...
        category: 'Physical',
        desc:
            "Paralyzes opponents. Base Power scales with the base move's Base Power.",
    ...
    gravapple: {
        ...
        category: 'Physical',
        desc:
            "Has a 100% chance to lower the target's Defense by 1 stage. This move's base power is 1.5x stronger in Gravity.",
        ...
        effect: {
            ...
            onStart(target) {
                ...
                this.add(
                    '-start',
                    target,
                    'stockpile' + this.effectData.layers
                );
        ...
        effect: {
            ...
            onTryPrimaryHit(target, source, move) {
                ...
                if (damage > target.volatiles['substitute'].hp) {
                    damage =
                        /** @type {number} */ (target.volatiles['substitute']
                            .hp);
                }
    ...
    teatime: {
        ...
        category: 'Status',
        desc:
            'Forces all active Pokemon to consume their held berries. This move bypasses Substitutes and Unnerve.',
